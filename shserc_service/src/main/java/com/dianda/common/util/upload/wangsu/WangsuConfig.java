...
public class WangsuConfig {
	...
	static final String UPLOAD_DOMAIN = "http://tejiao.up28.v1.wcsapi.com";
	static final String MANAGER_DOMAIN = "http://tejiao.mgr28.v1.wcsapi.com";
	...
	public static void init( ) {
	 ...
	 static class ErrorMessage{
		static  final  String FAIL="上传文件失败请联系管理员";
	}
