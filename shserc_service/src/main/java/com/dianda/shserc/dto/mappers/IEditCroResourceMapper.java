...
public interface IEditCroResourceMapper extends BasicMapper<CroResource, EditCroResourceDto> {
	
	 IEditCroResourceMapper INSTANCE= Mappers.getMapper ( IEditCroResourceMapper.class);
