<template>
  <el-dialog title="新增菜单" :visible.sync="visible" :before-close="handleClose">
    <el-form :model="company" ref="menuForm" :rules="rules">
      <el-form-item prop="name">
        <el-input prefix-icon="el-icon-search" v-model="company.name" placeholder="菜单名称"></el-input>
      </el-form-item>
      <el-form-item prop="parentId">
        <el-select @change="selectChanged" v-model="company.parentId" placeholder="请选择父级菜单" style="width: 100%">
          <el-option
